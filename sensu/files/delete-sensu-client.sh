...
curl -X DELETE http://access:granted@{{ sensu.rabbitmq.host }}:4567/clients/{% if sensu.client.add_machine_id -%}{{ grains['fqdn'] }}-{{ grains['machine_id'] }}{% else -%}{{ grains['fqdn']|json }}{% endif -%}
